...
void DAAppActions::buildChartAction()
{
	...
	actionFigureSettingApplyAllChart = createAction("actionFigureSettingApplyAllChart",
	                                                ":/app/bright/Icon/apply-to-all-figure.svg",
	                                                true,
	                                                true);
	...
	actionChartPickerTextAtLeftTop = createAction("actionChartPickerTextAtLeftTop",
	                                              ":/app/bright/Icon/left-top.svg",
	                                              true,
	                                              false,
	                                              actionGroupChartPickerTextRegion);
	actionChartPickerTextAtLeftTop->setData(QwtPlotSeriesDataPicker::TextOnCanvasTopLeft);
	actionChartPickerTextAtLeftBottom = createAction("actionChartPickerTextAtLeftBottom",
	                                                 ":/app/bright/Icon/left-bottom.svg",
	                                                 true,
	                                                 false,
	                                                 actionGroupChartPickerTextRegion);
	actionChartPickerTextAtLeftBottom->setData(QwtPlotSeriesDataPicker::TextOnCanvasBottomLeft);
	actionChartPickerTextAtRightTop = createAction("actionChartPickerTextAtRightTop",
	                                               ":/app/bright/Icon/right-top.svg",
	                                               true,
	                                               false,
	                                               actionGroupChartPickerTextRegion);
	...
	actionChartPickerTextFollowMouse = createAction("actionChartPickerTextFollowMouse",
	                                                ":/app/bright/Icon/follow-mouse.svg",
	                                                true,
	                                                true,
	                                                actionGroupChartPickerTextRegion);
...
void DAAppActions::retranslateUi()
{
	...
	actionShowRightSideBar->setText(tr("Show Righ \nSide Bar"));            // cn:显示左侧边栏
	// Config Category
