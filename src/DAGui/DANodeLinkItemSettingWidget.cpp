...
void DANodeLinkItemSettingWidget::updateLinkEndpointInfo(DAAbstractNodeLinkGraphicsItem* link)
{
    ...
    ui->comboBoxFrontStyle->setCurrentIndex(
            ui->comboBoxFrontStyle->findData((int)link->getEndPointType(DAAbstractNodeLinkGraphicsItem::OrientationFrom)));
    ui->comboBoxEndStyle->setCurrentIndex(
            ui->comboBoxEndStyle->findData((int)link->getEndPointType(DAAbstractNodeLinkGraphicsItem::OrientationTo)));
}
...
void DANodeLinkItemSettingWidget::initEndpointComboxBox()
{
    ...
    fn(DAAbstractNodeLinkGraphicsItem::EndPointNone, tr("None"));
    fn(DAAbstractNodeLinkGraphicsItem::EndPointTriangType);
}

QPixmap DANodeLinkItemSettingWidget::generateEndPointPixmap(DAAbstractNodeLinkGraphicsItem* link,
                                                            DAAbstractNodeLinkGraphicsItem::EndPointType epType)
{
    ...
    QTransform tf;
    tf.translate(0, px.height() / 2).rotate(270);
    painter.setTransform(tf);
    painter.drawPath(p);
    painter.drawLine(0, 0, 0, px.width());
    return px;
}

void DANodeLinkItemSettingWidget::onComboBoxLinkStyleCurrentIndexChanged(int index)
{
    DAAbstractNodeLinkGraphicsItem::LinkLineStyle s = DAAbstractNodeLinkGraphicsItem::LinkLineKnuckle;
    switch (index) {
    case 0:
        s = DAAbstractNodeLinkGraphicsItem::LinkLineKnuckle;
        break;
    case 1:
        s = DAAbstractNodeLinkGraphicsItem::LinkLineStraight;
        break;
    case 2:
        s = DAAbstractNodeLinkGraphicsItem::LinkLineBezier;
        break;
    default:
        break;
    }
...
void DANodeLinkItemSettingWidget::onComboBoxFrontStyleCurrentIndexChanged(int index)
{
    ...
    if (_linkItem) {
        _linkItem->setEndPointType(DAAbstractNodeLinkGraphicsItem::OrientationFrom, et);
        _linkItem->update();
    }
}
...
void DANodeLinkItemSettingWidget::onComboBoxEndStyleCurrentIndexChanged(int index)
{
    DAAbstractNodeLinkGraphicsItem::EndPointType et = static_cast< DAAbstractNodeLinkGraphicsItem::EndPointType >(index);
    if (_linkItem) {
        _linkItem->setEndPointType(DAAbstractNodeLinkGraphicsItem::OrientationTo, et);
        _linkItem->update();
    }
}
