...
public:
     ...
     */
    using ParamEditorCreator = std::function< QWidget*(const DAParamDef& paramDescriptor, QWidget* parent) >;
    ...
    QWidget* createEditor(const QString& typeStr, const DAParamDef& paramDescriptor, QWidget* parent = nullptr) const;
