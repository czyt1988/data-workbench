#ifndef DAPyWorkFlowEditWidget_H
 ...
 */
class DAGUI_API DAPyWorkFlowEditWidget : public QWidget
{
	Q_OBJECT
...
public:
	...
	// 获取GraphicsScene
	DAPyWorkFlowGraphicsScene* getWorkFlowGraphicsScene() const;
	// 激活UndoStack
	...
	void runWorkFlow();
	// 设置鼠标动作
	void setPreDefineSceneAction(DAPyWorkFlowGraphicsScene::SceneActionFlag mf);
