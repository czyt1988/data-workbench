 ...
 * @return
 */
QDomElement DAXmlHelper::makeClipBoardElement(const QList< DAGraphicsItem* > its, QDomDocument* doc, bool isCopyType)
{
	QDomElement rootEle = doc->createElement(QStringLiteral("da-clip"));
	if (isCopyType) {
