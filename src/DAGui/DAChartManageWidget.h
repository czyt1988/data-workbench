...
protected:
	// tree点击后的效果，如果setCurrentChartOnItemClicked或setCurrentChartOnItemDoubleClicked为true，点击后会自动设置对应的chart为current chart
...
signals:
	 ...
	 */
	void figureItemClicked(DA::DAFigureWidget* fig, DA::DAChartWidget* chart, QwtPlotItem* item);
	void figureItemDoubleClicked(DA::DAFigureWidget* fig, DA::DAChartWidget* chart, QwtPlotItem* item);
