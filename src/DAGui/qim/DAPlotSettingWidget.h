#ifndef DAPLOTSETTINGWIDGET_H
#define DAPLOTSETTINGWIDGET_H
 ...
 *
 */
class DAGUI_API DAPlotSettingWidget : public QWidget
{
    Q_OBJECT
    DA_DECLARE_PRIVATE(DAPlotSettingWidget)
public:
    /**
...
public:
    explicit DAPlotSettingWidget(QWidget* parent = nullptr);
    ~DAPlotSettingWidget();
    // 设置绘图
    void setPlotNode(QIM::QImPlotNode* plot);
...
private:
    Ui::DAPlotSettingWidget* ui;
};
}
#endif  // DAPLOTSETTINGWIDGET_H
