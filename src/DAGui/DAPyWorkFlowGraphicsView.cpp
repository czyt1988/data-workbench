 ...
 * @return
 */
DAPyNodeGraphicsItem* DAPyWorkFlowGraphicsView::createNode(const DAPyNodeMetaData& md, const QPoint& pos)
{
	auto secen = getWorkFlowGraphicsScene();
	if (!secen) {
		return nullptr;
...
DAPyNodeGraphicsItem* DAPyWorkFlowGraphicsView::createNode_(const DAPyNodeMetaData& md, const QPoint& pos)
{
	auto secen = getWorkFlowGraphicsScene();
	if (!secen) {
		return nullptr;
