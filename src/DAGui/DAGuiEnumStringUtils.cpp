...
DA_ENUM_STRING_INSENSITIVE_DEFINE(
    DA::DAColorTheme::ColorThemeStyle,
...
DA_ENUM_STRING_INSENSITIVE_DEFINE(
    QwtDate::Week0Type, QwtDate::FirstThursday, { QwtDate::FirstThursday, "firstThursday" }, { QwtDate::FirstDay, "firstDay" }
);
