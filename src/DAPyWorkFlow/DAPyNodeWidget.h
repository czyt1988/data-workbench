 ...
 *
 * 继承DAAbstractNodeWidget，根据DANodeDescriptor.parameters动态生成表单控件。
 ...
 * @endcode
 *
 * @see DAAbstractNodeWidget DAPyParamTypeHelper DAPyNodeConfigDialog
 */
class DAPYWORKFLOW_API DAPyNodeWidget : public DAAbstractNodeWidget
{
    Q_OBJECT
