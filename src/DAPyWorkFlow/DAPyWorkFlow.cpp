...
DAPyWorkFlow::DAPyWorkFlow(QObject* parent) : QObject(parent), DAPyObjectWrapper()
{
    initPyWorkflow();
}

DAPyWorkFlow::DAPyWorkFlow(const pybind11::object& obj, QObject* parent) : QObject(parent), DAPyObjectWrapper(obj)
{
}
