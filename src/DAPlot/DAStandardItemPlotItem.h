 ...
 */
class DAPLOT_API DAStandardItemPlotItem : public QStandardItem
{
public:
    enum
    {
    ...
    enum ItemType
    {
        ...
        PlotItemProperty  ///< 显示item的颜色，一般用于第三列
    };
    explicit DAStandardItemPlotItem(QIM::QImPlotItemNode* item, ItemType plotItemType);
    ...
    // 获取关联的PlotItem
    QIM::QImPlotItemNode* plotItem() const
    {
        return m_plotItem;
    }
...
private:
    QIM::QImPlotItemNode* m_plotItem { nullptr };
