...
Q_SIGNALS:
    ...
    void axisClicked(QwtAxisId axisId, QwtPlot* plot, QStandardItem* treeItem);
    ...
    void axisDoubleClicked(QwtAxisId axisId, QwtPlot* plot, QStandardItem* treeItem);
...
private:
    ...
    void emitAxisClick(int axisId, QwtPlot* plot, QStandardItem* item, bool db);
