...
public:
    ...
    virtual void setCanvasBackground(const QBrush& brush) = 0;
    virtual QBrush getCanvasBackground() const            = 0;

    // ==================== 坐标轴样式 ====================
    virtual void setAxisLabel(int axisId, const QString& label) = 0;
    virtual QString getAxisLabel(int axisId) const              = 0;

    virtual void setAxisFont(int axisId, const QFont& font) = 0;
    virtual QFont getAxisFont(int axisId) const             = 0;

    virtual void setAxisColor(int axisId, const QColor& color) = 0;
    virtual QColor getAxisColor(int axisId) const              = 0;

    virtual void showAxis(int axisId, bool visible = true) = 0;
    virtual bool isAxisVisible(int axisId) const           = 0;
    ...
    virtual void
    setGridStyle(const QColor& color, qreal width = 1.0, Qt::PenStyle style = Qt::DotLine, bool isMajor = true) = 0;
    ...
    // ==================== 高级样式设置 ====================
    virtual void setAxesMargin(int margin) = 0;
    virtual int getAxesMargin() const      = 0;

    virtual void setAutoReplot(bool autoReplot) = 0;
    virtual bool isAutoReplot() const           = 0;
};
