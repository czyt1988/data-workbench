...
/// \param chart
///
QString DAChartUtil::plotTitle(QwtPlot* plot, QwtFigure* fig)
{
    if (!plot) {
...
QString DAChartUtil::plotItemName(QwtPlotItem* item)
{
...
QIcon DAChartUtil::plotItemIcon(QwtPlotItem* item)
{
