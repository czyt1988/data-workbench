...
public:
    ...
    virtual void zoomToRect(const QRectF& rect) = 0;
    ...
    // ==================== 数据拾取控制 ====================
    virtual void enableDataPicking(bool enable = true) = 0;
    virtual bool isDataPickingEnabled() const          = 0;
    ...
    // ==================== 批量交互控制 ====================
    virtual void enableAllInteractions(bool enable) = 0;
    virtual void disableAllInteractions()           = 0;
