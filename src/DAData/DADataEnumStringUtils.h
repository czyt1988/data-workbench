#ifndef DADATAENUMSTRINGUTILS_H
#define DADATAENUMSTRINGUTILS_H
#include "DADataAPI.h"
...
// ------------------------------------------
DA_ENUM_STRING_DECLARE_EXPORT(DADATA_API, DA::DAAbstractData::DataType)
#endif  // DADATAENUMSTRINGUTILS_H
