...
// ------------------------------------------
DA_ENUM_STRING_DECLARE_EXPORT(DAWORKFLOW_API, DA::DAAbstractNodeGraphicsItem::LinkPointLocation)

// ------------------------------------------
// DA::DANodeLinkPoint::Way
// ------------------------------------------
DA_ENUM_STRING_DECLARE_EXPORT(DAWORKFLOW_API, DA::DANodeLinkPoint::Way)
#endif  // DAWORKFLOWENUMSTRINGUTILS_H
