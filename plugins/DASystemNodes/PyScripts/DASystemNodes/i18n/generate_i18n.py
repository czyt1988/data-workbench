...
# ===================== Configuration =====================
# Script is at DASystemNodes/i18n/generate_i18n.py
# Package root is DASystemNodes/ (parent of i18n/)
SCRIPT_DIR = Path(__file__).parent.resolve()          # .../DASystemNodes/i18n/
PACKAGE_DIR = SCRIPT_DIR.parent                        # .../DASystemNodes/
