...
若列名包含空格或特殊字符，需用反引号包围（`` ` ``），如 `` `Embarked On` ``。""",
    ...
    # ---- DA::DAAgentDockAreaTitleBar (session-tabs) ----
    ("DA::DAAgentDockAreaTitleBar", "New Session"): "新建会话",
    ("DA::DAAgentDockAreaTitleBar", "Session Manager"): "会话管理",

    # ---- DA::DAAgentDockWidget (session-tabs 宿主) ----
    ("DA::DAAgentDockWidget", "No agent session is open"): "没有打开的 Agent 会话",
    ("DA::DAAgentDockWidget", "Rename Session"): "重命名会话",
    ("DA::DAAgentDockWidget", "Session name:"): "会话名称：",
    ("DA::DAAgentDockWidget", "Delete Session"): "删除会话",
    ("DA::DAAgentDockWidget", 'Delete session "%1"? Its chat history will be removed.'): "删除会话“%1”？其聊天记录将被移除。",
    ("DA::DAAgentDockWidget", 'Session "%1" is waiting for your input. What do you want to do?'): "会话“%1”正在等待你的输入。要如何处理？",
    ("DA::DAAgentDockWidget", 'Session "%1" is still running. What do you want to do?'): "会话“%1”仍在运行中。要如何处理？",
    ("DA::DAAgentDockWidget", "Close Session"): "关闭会话",
    ("DA::DAAgentDockWidget", "Keep Running in Background"): "后台继续运行",
    ("DA::DAAgentDockWidget", "Stop Session and Close"): "停止会话并关闭",

    # ---- DA::DAAgentSessionDockWidgetTab (session-tabs 标签右键菜单) ----
    ("DA::DAAgentSessionDockWidgetTab", "Rename Session"): "重命名会话",
    ("DA::DAAgentSessionDockWidgetTab", "Stop Session"): "停止会话",
    ("DA::DAAgentSessionDockWidgetTab", "Delete Session"): "删除会话",

    # ---- DA::DAAgentSessionChatWidget (session-tabs 单会话视图，源码 cn: 注释对照) ----
    ("DA::DAAgentSessionChatWidget", "Send"): "发送",
    ("DA::DAAgentSessionChatWidget", "Stop"): "终止",
    ("DA::DAAgentSessionChatWidget", "Ready"): "就绪",
    ("DA::DAAgentSessionChatWidget", "Agent starting..."): "Agent 启动中...",
    ("DA::DAAgentSessionChatWidget", "Agent thinking..."): "Agent 思考中...",
    ("DA::DAAgentSessionChatWidget", "Stopping..."): "终止中...",
    ("DA::DAAgentSessionChatWidget", "Type a message..."): "输入消息...",
    ("DA::DAAgentSessionChatWidget", "tokens: -"): "token: -",
    ("DA::DAAgentSessionChatWidget", "input: %1"): "输入：%1",
    ("DA::DAAgentSessionChatWidget", "output: %1"): "输出：%1",
    ("DA::DAAgentSessionChatWidget", "total: %1"): "总计：%1",
    ("DA::DAAgentSessionChatWidget", "window: %1"): "窗口：%1",
    ("DA::DAAgentSessionChatWidget", "source: %1"): "来源：%1",
    ("DA::DAAgentSessionChatWidget", "unknown"): "未知",
    ("DA::DAAgentSessionChatWidget", "No model"): "无模型",
    ("DA::DAAgentSessionChatWidget", "Select LLM model"): "选择 LLM 模型",
    ("DA::DAAgentSessionChatWidget", "Providers"): "供应商",
    ("DA::DAAgentSessionChatWidget", "Back"): "返回",
    ("DA::DAAgentSessionChatWidget", "Details"): "详细信息",
    ("DA::DAAgentSessionChatWidget", "Copy"): "复制",
    ("DA::DAAgentSessionChatWidget", "Copied"): "已复制",
    ("DA::DAAgentSessionChatWidget", "[truncated]"): "[已截断]",
    ("DA::DAAgentSessionChatWidget", "Permission mode"): "权限模式",
    ("DA::DAAgentSessionChatWidget", "Full Auto"): "全自动",
    ("DA::DAAgentSessionChatWidget", "Auto"): "自动",
    ("DA::DAAgentSessionChatWidget", "Ask Every Time"): "每次询问",
    ("DA::DAAgentSessionChatWidget", "Run everything without asking (system directories still blocked)"): "全部直接执行不再询问（系统目录仍拦截）",
    ("DA::DAAgentSessionChatWidget", "Reads and chart edits pass; file writes and code execution judged by rules"): "读取与图表编辑放行；文件写入与代码执行按规则判定",
    ("DA::DAAgentSessionChatWidget", "File writes and code execution need approval every time"): "文件写入与代码执行每次都需批准",
    ("DA::DAAgentSessionChatWidget", "Switch to Full Auto mode? Code execution and file writes will no longer ask for confirmation."): "切换到全自动模式？代码执行与文件写入将不再请求确认。",
    ("DA::DAAgentSessionChatWidget", "Switch"): "切换",
    ("DA::DAAgentSessionChatWidget", "Cancel"): "取消",
    ("DA::DAAgentSessionChatWidget", "needs your approval"): "需要你的批准",
    ("DA::DAAgentSessionChatWidget", "Approve"): "批准",
    ("DA::DAAgentSessionChatWidget", "Deny"): "拒绝",
    ("DA::DAAgentSessionChatWidget", "Approve && remember for this session"): "批准并本会话记住",
    ("DA::DAAgentSessionChatWidget", "Approved"): "已批准",
    ("DA::DAAgentSessionChatWidget", "Denied"): "已拒绝",
    ("DA::DAAgentSessionChatWidget", "Approved (remembered for this session)"): "已批准（本会话已记住）",
    ("DA::DAAgentSessionChatWidget", "%1 more lines"): "还有 %1 行",
    ("DA::DAAgentSessionChatWidget", "From subagent: %1"): "来自子 Agent：%1",
    ("DA::DAAgentSessionChatWidget", "%1 subagent task(s)"): "%1 个子 Agent 任务",
    ("DA::DAAgentSessionChatWidget", "%1/%2 done"): "%1/%2 已完成",
    ("DA::DAAgentSessionChatWidget", "completed"): "已完成",
    ("DA::DAAgentSessionChatWidget", "queued"): "排队中",
    ("DA::DAAgentSessionChatWidget", "running"): "运行中",
    ("DA::DAAgentSessionChatWidget", "done"): "完成",
    ("DA::DAAgentSessionChatWidget", "failed"): "失败",
    ("DA::DAAgentSessionChatWidget", "timeout"): "超时",
    ("DA::DAAgentSessionChatWidget", "stopped"): "已停止",
    ("DA::DAAgentSessionChatWidget", "Load earlier messages"): "加载更早消息",
    ("DA::DAAgentSessionChatWidget", "The permission mode is Full Auto from last session. Code execution and file writes will run without asking. Keep Full Auto mode?"): "上次会话留在全自动权限模式。代码执行与文件写入将不再询问直接执行。是否保持全自动模式？",
    ("DA::DAAgentSessionChatWidget", "Keep Full Auto"): "保持全自动",
    ("DA::DAAgentSessionChatWidget", "Switch to Auto"): "切换为自动",
    ("DA::DAAgentSessionChatWidget", "tokens: ~%1 / %2"): "token: ~%1 / %2",
    ("DA::DAAgentSessionChatWidget", "tokens: %1 / %2"): "token: %1 / %2",
    ("DA::DAAgentSessionChatWidget", "API quota exhausted, please check account balance or change API key"): "API 配额已耗尽，请检查账户余额或更换 API Key",
    ("DA::DAAgentSessionChatWidget", "API key invalid or expired, please check settings"): "API Key 无效或已过期，请在设置中检查配置",
    ("DA::DAAgentSessionChatWidget", "Failed after %1 retries: rate limited"): "重试 %1 次后仍失败：服务限流",
    ("DA::DAAgentSessionChatWidget", "Failed after %1 retries: network error"): "重试 %1 次后仍失败：网络错误",
    ("DA::DAAgentSessionChatWidget", "Failed after %1 retries: server error"): "重试 %1 次后仍失败：服务器错误",
    ("DA::DAAgentSessionChatWidget", "Request format error: %1"): "请求格式错误：%1",
    ("DA::DAAgentSessionChatWidget", "Context window exceeded and compaction failed"): "上下文窗口超限且压缩失败",
    ("DA::DAAgentSessionChatWidget", "Agent response timeout (no activity for %1 minutes)"): "Agent 响应超时（%1 分钟无活动）",
    ("DA::DAAgentSessionChatWidget", "Agent process crashed, recovering... (%1/3)"): "Agent 进程异常退出，正在恢复... (%1/3)",
    ("DA::DAAgentSessionChatWidget", "Agent process crashed repeatedly, unable to recover"): "Agent 进程多次崩溃，无法恢复",
    ("DA::DAAgentSessionChatWidget", "Failed to switch model, keeping current model"): "模型切换失败，已保留当前模型",
    ("DA::DAAgentSessionChatWidget", "Agent error: %1"): "Agent 错误：%1",

    # ---- DA::DAAgentModule (session-tabs：回合未完成提醒迁移到会话广播路径) ----
    ("DA::DAAgentModule", 'The agent ended this turn after %1 tool calls, but its last message looks like an unfinished plan (e.g. announcing a next step without executing it). Send a message such as "continue" to let it finish.'): "Agent 在执行 %1 轮工具调用后结束了本轮，但最后的回复疑似未完成的计划（如宣称下一步却未执行）。可发送“继续”等消息让它完成剩余工作。",

    # ---- DA::DAAppRibbonArea (session-tabs 新增按钮) ----
    ("DA::DAAppRibbonArea", "New Session"): "新建会话",
    ("DA::DAAppRibbonArea", "Open a new agent chat session"): "打开一个新的 Agent 会话标签页",
    ("DA::DAAppRibbonArea", "Session Manager"): "会话管理",
    ("DA::DAAppRibbonArea", "Manage agent sessions: switch, rename, delete"): "管理 Agent 会话：切换、重命名、删除",

    # ---- QObject (session-tabs 宿主 PrivateData 的 QObject::tr：状态文案/未命名标题) ----
    ("QObject", "(untitled)"): "（未命名）",
    ("QObject", "Starting"): "启动中",
    ("QObject", "Running"): "运行中",
    ("QObject", "Waiting for you"): "等待输入",
    ("QObject", "Error"): "出错",

    # ---- DA::DADialogAgentSessionManager（会话管理对话框，本次 Ribbon 入口集成的既有文案） ----
    ("DA::DADialogAgentSessionManager", "State"): "状态",
    ("DA::DADialogAgentSessionManager", "Session Details"): "会话详情",
    ("DA::DADialogAgentSessionManager", "Select a session to view details"): "选中会话查看详情",
    ("DA::DADialogAgentSessionManager", "Input Tokens"): "输入 tokens",
    ("DA::DADialogAgentSessionManager", "Output Tokens"): "输出 tokens",
    ("DA::DADialogAgentSessionManager", "Total Tokens"): "合计 tokens",
    ("DA::DADialogAgentSessionManager", "Created"): "创建时间",
    ("DA::DADialogAgentSessionManager", "Starting"): "启动中",
    ("DA::DADialogAgentSessionManager", "Running"): "运行中",
    ("DA::DADialogAgentSessionManager", "Waiting for you"): "等待输入",
    ("DA::DADialogAgentSessionManager", "Error"): "出错",
    ("DA::DADialogAgentSessionManager", "Idle"): "空闲",
    ("DA::DADialogAgentSessionManager", "%1 sessions · %2 tokens total"): "共 %1 个会话 · 累计 tokens %2",

    # ---- DA::DAAgentBridge（子进程未运行提示，会话交互直接相关） ----
    ("DA::DAAgentBridge", "Message not sent: agent subprocess is not running"): "消息未发送：agent 子进程未运行",
    ("DA::DAAgentBridge", "Answer not sent: agent subprocess is not running"): "回答未发送：agent 子进程未运行",
}
