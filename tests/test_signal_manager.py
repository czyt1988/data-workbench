...
import pytest
from DAWorkbench.DAWorkFlowPy import DAWorkflow, DAConnection, DASignalManager, DAWorkflowState
...
def _make_simple_workflow():
    ...
    from DAWorkbench.DAWorkFlowPy import NodeDef, Output, Input
...
class TestDASignalManagerCallback:
    ...
    def test_state_change_callback_on_start(self):
        ...
        transitions = []
        wf = DAWorkflow()
        mgr = DASignalManager(wf, on_state_change=lambda o,
                              n: transitions.append((o, n)))
        mgr.start()
